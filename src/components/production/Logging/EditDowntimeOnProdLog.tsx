...
const EditDowntimeOnProductionLog: React.FC<EditDowntimeOnProdLogProps> = ({
  open,
  onClose,
  log,
  downtime,
  ...
  const mutation = useMutation({
    mutationFn: (data: DowntimeUpdate) =>
      ProductionLogsService.updateProductionDowntimeApiV1ProductionLogsDowntimesIdPut(
        {
          // @ts-ignore
          id: downtime.id,
          requestBody: data,
  ...
  const onSubmit: SubmitHandler<DowntimeUpdate> = async (data) => {
...
export default EditDowntimeOnProductionLog;
